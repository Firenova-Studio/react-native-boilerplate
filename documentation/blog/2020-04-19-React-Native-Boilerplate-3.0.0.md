...
This boilerplate is the core of every react-native application we develop and maintain at FireNova Studio.
...
```
npx react-native init --template @firenova-studio/react-native-boilerplate
yarn start
yarn ios
yarn android
```
