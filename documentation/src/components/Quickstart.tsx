        ...
        <div className="relative flex justify-end">
          ...
          <div className="relative w-[320px] sm:absolute sm:left-16 sm:-top-5 sm:w-[62%] p-5 sm:p-2">
            ...
            >
              ...
              --template @firenova-studio/react-native-boilerplate
            </CodeBlock>
            ...
            <div>
              <button
                ...
                onClick={() => { navigator.clipboard.writeText('npx @react-native-community/cli@latest init MyApp --template @firenova-studio/react-native-boilerplate'); }}
              >
                Copy and test it
