...
import { config } from '@/shared/lib/theme/_config';
import type { UnionConfiguration } from '@/shared/lib/theme/types/config';
import type { FontColors, FontSizes } from '@/shared/lib/theme/types/fonts';
